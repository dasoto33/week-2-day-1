...
# Problem Statement:
# You are given two strings, A and B. Your task is to count how many strings equal to A can be constructed using 
...
# Task:
# Your task is to write a Python function that takes in two strings, A and B, and returns the count of strings 
# equal to A that can be constructed using letters from B.
...
if so; keep count of said letter
look through counts
